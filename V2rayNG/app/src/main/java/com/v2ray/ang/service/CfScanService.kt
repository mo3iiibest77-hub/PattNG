...
class CfScanService : Service() {
    ...
    companion object {
        ...
        const val EXTRA_MODE   = "mode"    // "discovery" | "scan"
        ...
        fun startDiscovery(ctx: Context, guid: String, ispName: String) {
            val i = Intent(ctx, CfScanService::class.java).apply {
    ...
    private fun runScan(guid: String, ispName: String) {
        ...
        CloudflareScanner.scanForIsp(
            ...
            callback = object : ScanCallback {
                ...
                override fun onCancelled() { stopSelf() }
            }
        )
    }

    private fun createChannel() {
        val ch = NotificationChannel(CHANNEL_ID, "CF Scanner", NotificationManager.IMPORTANCE_LOW)
        ch.description = "اسکن Cloudflare در پس‌زمینه"
    ...
    private fun buildNotif(text: String): Notification {
        ...
        return Notification.Builder(this, CHANNEL_ID)
            ...
            .addAction(Notification.Action.Builder(null, "توقف", stopIntent).build())
            .setOngoing(true)
            .build()
    }
